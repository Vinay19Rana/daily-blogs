...
export const data = [
  {
    category: "Wealth",
    slug: "bitcoin_breaks",
    title: "Bezos saved about $288m by moving to Florida",
    description:
  ...
  },
  {
    category: "Tech",
    slug: "bitcoin_breaks",
    title: "Zuck says Quest 3 headset > Vision Pro",
    description:
      "What’s surprising is that he shouted it from the rooftops on his personal Instagram account.",
    author: "Hartej",
    image:
      "https://images.unsplash.com/photo-1512756290469-ec264b7fbf87?q=80&w=1953&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    category: "Labor",
    slug: "bitcoin_breaks",
    title: "Uber and Lyft drivers plan Valentine’s strike for fair pay",
    description:
      "More than 130,000 drivers in major US cities are expected to refuse rides to and from the airport for two hours today.",
    author: "Hartej",
    image:
